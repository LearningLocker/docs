The contribution guidelines can be found at http://docs.learninglocker.net/contribute.
...
- [Correction](../../issues/new?title={{Brief description of your correction}}&body=**Expected text**%0A{{page}} should state {{expectedText}} because {{reason}}.%0A%0A**Actual text**%0A{{page}} states {{actualText}}.%0A%0A**Additional information**%0A{{additionalInfo}}): reports a feature that is not working as expected.)
